...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/zeno"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutzenoAction = new QAction(MainWindow);
        m_aboutzenoAction->setObjectName(QStringLiteral("m_aboutzenoAction"));
        m_aboutzenoAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutzenoAction);
        ...
        QObject::connect(m_aboutzenoAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutzenoAction->setText(QApplication::translate("MainWindow", "About zeno", Q_NULLPTR));
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND zenoS", Q_NULLPTR));
